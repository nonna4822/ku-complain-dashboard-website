...
while($row = mysqli_fetch_array($result)) {
    $selectObj = $selectObj."<tr>
      ...
      "<td><center><button class='btn btn-outline-danger' style='width:100px; height:40px;' onclick=\"window.location = '../management/updateuser.php?stuid=" . $row['stuid'] ."';\">ลบ</button></center></td>".
    "</tr>";
}
echo $selectObj;
